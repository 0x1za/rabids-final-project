...
<section class="sm-slider flexslider sm-inner">
    <ul class="slides">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="sm-slider-text text-center">
                            ...
                            <h1 class="sm-heading sm-animate">Best Rooms</h1>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sm-room">
                    <a href="#"><img src="img/img_4.jpg" alt="" class="img-responsive"></a>
                    <div class="text">
                        <h3>Classic Room</h3>
                        <p>Starting from <strong>RWF 2900.00/Night</strong></p>
                        ...
                        <p><a href="#" class="btn btn-primary" role="button">Reserve now for RWF 2900.00</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sm-room">
                    ...
                    <div class="text">
                        ...
                        <p><a href="#" class="btn btn-primary" role="button">Reserve now for RWF 29.00</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sm-room">
                    <a href="#"><img src="img/img_5.jpg" alt="" class="img-responsive"></a>
                    <div class="text">
                        <h3>Grand Deluxe Room</h3>
                        <p>Starting from <strong>RWF 2900.00/Night</strong></p>
                        <div class="post-meta mb30">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sm-room">
                    <a href="#"><img src="img/img_6.jpg" alt="" class="img-responsive"></a>
                    <div class="text">
                        <h3>Ultra Superior Room</h3>
                        <p>Starting from <strong>RWF 2900.00/Night</strong></p>
                        <div class="post-meta mb30">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="sm-room">
                    <a href="#"><img src="img/img_7.jpg" alt="" class="img-responsive"></a>
                    <div class="text">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="service left-icon left-icon-sm sm-animate">
                    <div class="icon">
...
<section class="hotel-section probootstrap-section-dark">
    <div class="container">
        <div class="row mb30">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="service left-icon sm-animate">
                    <div class="icon">
                        <img src="img/flaticon/svg/001-building.svg" class="svg" alt="">
                    </div>
                    <div class="text">
                        <h3>1+ Million Hotel Rooms</h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            ...
            <div class="col-md-4">
                <div class="service left-icon sm-animate">
                    <div class="icon">
                        <img src="img/flaticon/svg/003-restaurant.svg" class="svg">
                    </div>
                    <div class="text">
                        <h3>Food &amp; Drinks</h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            ...
            <div class="col-md-4">
                <div class="service left-icon sm-animate">
                    <div class="icon">
                        <img src="img/flaticon/svg/004-parking.svg" class="svg" alt="">
                    </div>
                    <div class="text">
                        <h3>Airport Taxi</h3>
                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
